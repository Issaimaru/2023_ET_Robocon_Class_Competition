/*
 *  kernel_cfg.c
 *  Thu Jun 22 08:35:29 2023
 *  SG Version 2.00
 *  sg.exe nxtway_gs.oil -os=ECC2 -IC:/Users/e2011220/Desktop/nxtOSEK/toppers_osek/sg/impl_oil -template=C:/Users/e2011220/Desktop/nxtOSEK/toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType Task_4ms = 0;
const TaskType Task_20ms = 1;
const TaskType Task_100ms = 2;
...
const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 3, TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 1, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 3, TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 1, };
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( Task_4ms ), TASKNAME( Task_20ms ), TASKNAME( Task_100ms ), TASKNAME( Task_Background ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Task_4ms, (__STK_UNIT)_stack_Task_20ms, (__STK_UNIT)_stack_Task_100ms, (__STK_UNIT)_stack_Task_Background, };
...
const AlarmType Alarm_task_4ms = 0;
const AlarmType Alarm_task_20ms = 1;
const AlarmType Alarm_task_100ms = 2;
...
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_Alarm_task_4ms, _activate_alarm_Alarm_task_20ms, _activate_alarm_Alarm_task_100ms, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 4, 20, 100, };
